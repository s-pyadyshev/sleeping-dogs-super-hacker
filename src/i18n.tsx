  ...
  resources: {
    en: {
      translation: {
        ...
        howtoplay: {
          ...
          green: "Valid digit",
          controls:
            "Use WASD (arrows on mobile) to navigate and increase/decrease digits. Press Enter to check validity.",
        },
        about: {
          ...
          text4: "Tech stack",
          text5:
            "I had to practice MobX and the world needs anything but another ToDo list.",
    ...
    ru: {
      translation: {
        ...
        howtoplay: {
          start:
            "Угадай код из 4 УНИКАЛЬНЫХ цифр. У тебя только 6 попыток. И время идёт!",
          yellow: "Цифра есть, но в другом месте",
          red: "Цифры в коде нет",
          green: "Цифра угадана верно",
          controls:
            "Используй клавиши WASD или стрелки для перемещения и увеличения/уменьшения значения. Нажми Enter для проверки кода.",
        },
        about: {
          ...
          text4: "Стек",
          text5:
            "Мне нужно было попрактиковаться с MobX, поэтому мне нужно было себя чем-то замотивировать и вот вы здесь.",
